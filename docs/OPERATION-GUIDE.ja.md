...
![Lighting タブ](screenshots/tab-backlight.png)
...
Combo タブは全エントリを一覧表示する**タイルグリッドプレビュー**と設定エリアを備えています。「これらの機能はキーボード全体に適用されます（現在のレイヤーだけではありません）」という注記が表示されます。
...
![デュアルモード](screenshots/dual-mode.png)
...
- 左パネル: Combo エディタ (Key 1--4, Output フィールド)。Timeout (ms) と Save ボタン (グローバル Combo タイムアウト用)。
