...
export interface TypingTestResult {
   ...
   *  for the counting rules). Omitted when the run had no mistakes. Stored
   *  on the result for the completion screen's "missed characters" list;
   *  not yet surfaced in Analyze. */
