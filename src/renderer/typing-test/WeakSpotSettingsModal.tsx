 ...
 *  component directly since their option sets aren't plain numbers). Each
 *  button carries `aria-pressed` so a screen reader announces the current
 *  selection the same way a native toggle-button group would.
 *  `groupLabelledBy`, when given, marks the row as a
