...
// callers reach `wordWeakSpotScore`/`pickWeightedIndex`/
// `DEFAULT_WEAK_SPOT_BIAS_RATIO` by importing straight from
// './weak-spot-weighting' (they're internal to the sampling algorithm,
// not part of this barrel's public surface).
