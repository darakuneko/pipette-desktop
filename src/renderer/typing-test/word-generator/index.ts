...
export { wordWeakSpotScore, pickWeightedIndex, WEAK_SPOT_BIAS_RATIO } from './weak-spot-weighting'
export type { WeakSpotInputMethod, WeakSpotBiasProfile } from './weak-spot-weighting'
