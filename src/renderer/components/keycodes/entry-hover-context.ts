...
// (`PipetteSettings.entryHoverPreview`, "Fav Hover Details"). Provided once by
// `PickerPrefsProvider.tsx` in `App.tsx`, around both the editor surface and
// the app-level modals, so
