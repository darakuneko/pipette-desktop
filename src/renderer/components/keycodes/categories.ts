...
export const KEYCODE_CATEGORIES: KeycodeCategory[] = [
  ...
  },
  {
    ...
    getGroups: () => [
      ...
      { labelKey: 'keycodes.group.oneShotControl', keycodes: KEYCODES_MOD_ONESHOT_CTRL, layoutRow: 1 },
      {
      ...
      { labelKey: 'keycodes.group.modSpecial', keycodes: KEYCODES_MOD_SPECIAL, layoutRow: 2 },
      {
  ...
  },
  {
    ...
    getGroups: () => [
      ...
      { labelKey: 'keycodes.group.browser', keycodes: KEYCODES_SYSTEM_BROWSER, layoutRow: 2 },
      { labelKey: 'keycodes.group.systemControl', keycodes: KEYCODES_SYSTEM_CONTROL, layoutRow: 3 },
      { labelKey: 'keycodes.group.lockingKeys', keycodes: KEYCODES_SYSTEM_LOCK, layoutRow: 3 },
      { labelKey: 'keycodes.group.app', keycodes: KEYCODES_SYSTEM_APP, layoutRow: 3 },
    ],
  },
  {
    id: 'midi',
  ...
  },
  {
    ...
    getGroups: () => [
      ...
      { labelKey: 'keycodes.group.autocorrect', keycodes: KEYCODES_BEHAVIOR_AUTOCORRECT, layoutRow: 3 },
      { labelKey: 'keycodes.group.leader', keycodes: KEYCODES_BEHAVIOR_LEADER, layoutRow: 3 },
      ...
      { labelKey: 'keycodes.group.tappingTerm', keycodes: KEYCODES_BEHAVIOR_TAPPING_TERM, layoutRow: 4 },
    ],
  },
  {
    id: 'user',
