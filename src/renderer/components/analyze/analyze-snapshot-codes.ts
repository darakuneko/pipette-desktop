...
// (chosen over patching the round-trip because the snapshot already
// carries everything needed to resolve its own labels without
// depending on the live session's keyboard context).
//
